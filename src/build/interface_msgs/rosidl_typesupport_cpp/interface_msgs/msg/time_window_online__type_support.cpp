...
static const _TimeWindowOnline_type_support_symbol_names_t _TimeWindowOnline_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_msgs, msg, TimeWindowOnline)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface_msgs, msg, TimeWindowOnline)),
  }
};
...
{
  return &::interface_msgs::msg::rosidl_typesupport_cpp::TimeWindowOnline_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interface_msgs, msg, TimeWindowOnline)() {
  return get_message_type_support_handle<interface_msgs::msg::TimeWindowOnline>();
}
